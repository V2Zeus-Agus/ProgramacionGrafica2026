...
Shader "AS_Building_Main"
{
	...
	SubShader
	{
		...
		{
			float4 color1 = IsGammaSpace() ? float4(0.5943396,0.5943396,0.5943396,0) : float4(0.3119799,0.3119799,0.3119799,0);
			float4 color2 = IsGammaSpace() ? float4(0.2716714,0.3375716,0.3490566,0) : float4(0.05998752,0.09323939,0.09992068,0);
			...
			float4 lerpResult23 = lerp( color1 , color2 , ( 1.0 - step( frac( ( lerpResult17 * _StripeScale ) ) , _StripeWidth ) ));
...
/*ASEBEGIN
Version=18900
171;73;1514;705;-1427.5;341;1;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;18;985.5,367;Inherit;False;Property;_Epsilon;Epsilon;3;0;Create;True;0;0;0;False;0;False;0.0001;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;1700.5,162;Inherit;False;Property;_StripeWidth;StripeWidth;1;0;Create;True;0;0;0;False;0;False;0.18;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1;1927.5,-325;Inherit;False;Constant;_BaseColor;BaseColor;0;0;Create;True;0;0;0;False;0;False;0.5943396,0.5943396,0.5943396,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;2;1927.5,-148;Inherit;False;Constant;_LineColor;LineColor;0;0;Create;True;0;0;0;False;0;False;0.2716714,0.3375716,0.3490566,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;8;2226.5,135;Inherit;False;Property;_SmoothnessValue;SmoothnessValue;2;0;Create;True;0;0;0;False;0;False;0.15;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=BB1CB616B2452DB5578D07E715A44697E7571DCB